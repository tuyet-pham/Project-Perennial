...
curl -X PUT $HOST/plant_device/0d2186ea38e106dd06b16f95ee011150 -d '{"name": "Living Room", "username": "teamfullsteam", "species": "Begonia", "location": { "geolocationCity": "Irving", "geolocationState": "CO", "indoorsOutdoors": "indoors"}, "wateringConditionTrigger": "moisture", "wateringConditionValue": "50", "additionalNotes": ""}'
